...
#define LogEnable NO
#endif
#define DebugLog(__FORMAT__, ...) { if (LogEnable) NSLog((@"🔶%@ FUNCTION%s 🔷LINE-%d " __FORMAT__), [[NSString stringWithUTF8String: __FILE__] lastPathComponent], __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__);}
